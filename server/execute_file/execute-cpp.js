...
const executeCpp = async (filePath,questionId) => {

    console.log("I am inside executeCpp");
    ...
    try {
        ...
        if (docSnap.exists) {
            ...
            return new Promise((resolve,reject) => {
                exec(
                    `g++ ${filePath} -o ${execPath} &&
                     ...
                     rm -rf ${filePathInput} &&
                     rm -rf ${filePath} &&
                    if grep -Fxq -f test.txt output.txt; then echo "Code passed all test cases"; else echo "Hidden test cases failed"; fi && rm -rf output.txt && rm -rf test.txt ||
          ...
          console.log("Mujhe files nahi mili");
        }
      } catch (error) {
